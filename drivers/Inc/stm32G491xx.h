...
#define SPI_CR1_MSTR			2		/* Master/Slave selection */
#define SPI_CR1_BR				3		/* Baud rate control (3-bit field)*/
...
#define SPI_CR2_NSSP			3		/* NSS pulse management enable */
#define SPI_CR2_FRF				4		/* Frame format enable */
#define SPI_CR2_ERRIE			5		/* Error interrupt enable */
#define SPI_CR2_RXNEIE			6		/* RX buffer not empty interrupt enable */
#define SPI_CR2_TXEIE			7		/* Tx buffer empty interrupt enable */
#define SPI_CR2_DS				8		/* Data size - 4 bits */
...
#define SPI_SR_RXNE				0		/* RX buffer */
